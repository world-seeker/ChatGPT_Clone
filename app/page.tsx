  ...
  return (
    ...
    <div className='flex space-x-2'>
      ...
      <div>
        ...
        <div className='space-y-2'>
          <p className='infoText'>
          "May occassianally generate incorrect information"
          </p>
          <p className='infoText'>
          "May occassianally produce harmfull instructions or biased content"
          </p>
          <p className='infoText'>
          "Limited knowlege of world events after 2021"
          </p>
        </div>
      </div>
    </div>
